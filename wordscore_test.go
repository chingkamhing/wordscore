...
func Test_WordScore(t *testing.T) {
	...
	tests := []struct {
		...
		// 0
		{&WordScore{MaxCombination: 100}, 4, []string{"0000"}},
		// 1
		{&WordScore{
			Chars:          []rune{'A', 'B', 'C'},
		...
		{&WordScore{
			...
			MaxCombination: 100,
		}, 4, []string{"ABCD", "ABCE", "ABDE", "ACDE", "BCDE"}},
		// 4
		{&WordScore{
			...
			MaxCombination: 100,
		}, 4, []string{"ABCD", "ABCE", "ABCF", "ABDE", "ABDF", "ABEF", "ACDE", "ACDF", "ACEF", "ADEF", "BCDE", "BCDF", "BCEF", "BDEF", "CDEF"}},
		// 5
		{&WordScore{
			Chars:          []rune{'A', 'B', 'C', 'D', 'E', 'F'},
			...
			MaxCombination: 100,
		}, 4, []string{"ABCD", "ABCE", "ABCF", "ABDE", "ABDF", "ABEF", "ACDE", "ACDF", "ACEF", "ADEF"}},
		// 6
		{&WordScore{
			Chars:          []rune{'A', 'B', 'C', 'D', 'E', 'F'},
